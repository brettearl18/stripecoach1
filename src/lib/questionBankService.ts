    ...
    questions: [
      {
        ...
        type: 'number',
        text: 'How many grams of protein did you consume today?',
        required: true,
        min: 0,
        max: 500,
      },
      {
        ...
        type: 'number',
        text: 'How many grams of carbohydrates did you consume today?',
        required: true,
        min: 0,
        max: 1000,
      },
      {
        ...
        type: 'number',
        text: 'How many grams of fat did you consume today?',
        required: true,
        min: 0,
        max: 200,
      },
      {
        ...
        type: 'select',
        text: 'How would you rate your macro balance today?',
        required: true,
        options: ['Excellent', 'Good', 'Fair', 'Poor'],
      },
      {
    ...
    questions: [
      {
        ...
        type: 'select',
        text: 'How would you rate your meal timing today?',
        required: true,
        options: ['Excellent', 'Good', 'Fair', 'Poor'],
      },
      {
        ...
        required: false,
        options: ['Breakfast', 'Lunch', 'Dinner', 'Snacks', 'None'],
      },
      {
        id: 'nutrition-meals-3',
        type: 'number',
        text: 'How many hours did you fast between meals?',
        required: true,
        min: 0,
        max: 24,
      },
      {
        ...
        type: 'select',
        text: 'How would you rate your meal prep this week?',
        required: true,
        options: ['Excellent', 'Good', 'Fair', 'Poor'],
      },
      {
