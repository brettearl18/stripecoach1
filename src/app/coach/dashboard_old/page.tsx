...
import { CheckInsOverview } from '@/components/coach/CheckInsOverview';
import type { CheckInResponse } from '@/components/coach/CheckInsOverview';
...
const mockCheckIns: CheckInResponse[] = [
  {
    ...
    aiSummary: '🎯 Progress Overview:\n' +
      '• Consistent with workouts (4/4 sessions completed)\n' +
      '• Meeting protein targets (140g average daily)\n' +
      '• Sleep quality improving (7.5hrs average)\n\n' +
      '⚠️ Areas for Attention:\n' +
      '• Reported difficulty with deadlift form\n' +
      '• Stress levels affecting recovery\n\n' +
      '💡 Recommended Focus:\n' +
      '• Schedule form check session\n' +
  ...
  },
  {
    ...
    aiSummary: '⚠️ Check-in Overdue:\n' +
      '• Last completed session: March 8th\n' +
      '• Previous goals included increasing cardio\n' +
      '• Mentioned schedule conflicts\n\n' +
      '📋 Last Check-in Summary:\n' +
      '• Was making good progress with meal prep\n' +
      '• Added 2 cardio sessions successfully\n' +
      '• Sleep quality needed improvement'
  },
  {
    id: '3',
    clientId: '3',
    ...
    aiSummary: '🌟 Weekly Achievements:\n' +
      '• Hit new PR in squats (85kg)\n' +
      '• Maintained caloric surplus goal\n' +
      '• Improved recovery routine\n\n' +
      '📊 Key Metrics:\n' +
      '• Weight: +0.5kg (on track)\n' +
      '• Energy levels: 8/10\n' +
      '• Workout adherence: 100%\n\n' +
      '🎯 Next Week Focus:\n' +
      '• Progressive overload on bench press\n' +
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="space-y-6">
              {mockClients.map((client) => (
                <div key={client.id} className="space-y-4">
                  ...
                  {mockIndividualInsights[client.id] && (
        ...
        {/* Replace the old Check-ins Overview section with the new component */}
        <CheckInsOverview checkIns={mockCheckIns} />
